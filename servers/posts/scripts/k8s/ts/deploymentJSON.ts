export default {
  ...
  "kind": "Deployment",
  "metadata": {
    "name": process.env.MICRO_APP_POSTS_DEPLOYMENT_NAME!,
  },
  "spec": {
    "replicas": 1,
    ...
    "template": {
      ...
      "spec": {
        "containers": [
          {
            "name": process.env.MICRO_APP_POSTS_CONTAINER_NAME!,
            "image": process.env.MICRO_APP_POSTS_DOCKER_TAG! + process.env.MICRO_APP_POSTS_DOCKER_TAG_VERSION!,
          }
        ]
      }
    }
