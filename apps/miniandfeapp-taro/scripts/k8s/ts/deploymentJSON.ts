export default {
  ...
  "kind": "Deployment",
  "metadata": {
    "name": process.env.MICRO_APP_CLIENT_DEPLOYMENT_NAME!,
  },
  "spec": {
    "replicas": 1,
    ...
    "template": {
      ...
      "spec": {
        "containers": [
          {
            "name": process.env.MICRO_APP_CLIENT_CONTAINER_NAME!,
            "image": process.env.MICRO_APP_CLIENT_DOCKER_TAG! + process.env.MICRO_APP_CLIENT_DOCKER_TAG_VERSION!,
          }
        ]
      }
    }
